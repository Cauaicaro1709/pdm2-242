...
// Feito por Cauã Icaro 

Future<void> main() async {
  // Imprimir o nome conforme solicitado
  print("nome: Cauã Icaro Cunha Siqueira");
  ...
  await inserirAluno(db, 'Cauã', 18);
  await inserirAluno(db, 'Gustavo', 18);

  // Consultar dados de forma assíncrona
  await consultarAlunos(db);

  // Atualizar dados de forma assíncrona
  await atualizarAluno(db, 1, 'Gustavo Modificado', 19);
